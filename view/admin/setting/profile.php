        ...
        <div class="p-4">
            ...
            <div class="row g-4">
                    ...
                    <div class="card p-3">
                        <div class="col-12 fs-6">
                            <form action="<?= url("/editprofile") ?>" method="post">
                                ...
                                <input value="<?= auth()->user()->email ?>" type="text" id="email" name="email" class="form-control" placeholder="email@gmail.com" autocomplete="off" aria-describedby="emailHelp" />
                                ...
                                <input value="<?= auth()->user()->no_hp ?>" type="text" id="nohp" name="nohp" class="form-control   only-number " placeholder="08xxxxxxxxxx" maxlength="13" autocomplete="off" />
                                </script>
                ...
                <div class="col-md-6">
                    <div class="card p-3">
                        <div class="col-12 fs-6">
                            <form action="<?= url("/gantipassprofile") ?>" method="post">
                                ...
                                <div class="input-group">
                                    <input type="password" id="password" name="password" class="form-control" placeholder="Masukkan kata sandi anda saat ini" maxlength="50" autocomplete="off" required />
                            ...
                            <?php endif; ?>
                                ...
                                <div class="input-group">
                                    <input type="password" id="newpass" name="newpass" class="form-control" placeholder="Masukkan kata sandi baru" maxlength="50" autocomplete="off" required />
                                    <button type="button" class="bg-transparent password-toggle border-0 position-absolute " style="top:50%;right:10px;transform:translateY(-50%)">
                                        <i class="fa fa-eye"></i>
                                    </button>
                                </div>
                                <?php if (session()->has("newpass")): ?>
                                <small class="text-danger "><?= session()->error("newpass") ?></small>
                            <?php endif; ?>
                                <label class="d-block mt-3 form-label" for="confirmpass">Konfirmasi Kata Sandi</label>
                                <div class="input-group">
                                    <input type="password" id="newpass" name="confirmpass" class="form-control" placeholder="Konfirmasi kata sandi" maxlength="50" autocomplete="off" required />
                                    <button type="button" class="bg-transparent password-toggle border-0 position-absolute " style="top:50%;right:10px;transform:translateY(-50%)">
                                        <i class="fa fa-eye"></i>
                                    </button>
                                </div>
                                <?php if (session()->has("confirmpass")): ?>
                                <small class="text-danger "><?= session()->error("confirmpass") ?></small>
                            <?php endif; ?>
