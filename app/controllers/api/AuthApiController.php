...
class AuthApiController
{
    ...
    public function Login()
    {
        try {
            ...
            $users = $this->model->UserModel->select("masyarakat.nik,password,role,masyarakat.no_kk,masyarakat.nama_lengkap,users.email,users.no_hp,foto_profile")->join("masyarakat", "masyarakat.nik", "users.nik")->where("users.nik", "=", $nik)->where("users.status", "=", 1)->first();
            if ($users) {
