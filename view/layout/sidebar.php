    ...
    <ul class="list-unstyled d-flex flex-column gap-2 py-4 px-2">
        ...
        <li>
            ...
            <ul class="list-unstyled ps-4">
                ...
                <li>
                    <a class="text-body-secondary sidebar-subitem side-link d-flex align-items-center px-3 rounded py-2 text-decoration-none" href="/admin/pasien">
                        <i class="fa fa-envelope"></i>
        ...
        <li>
            ...
            <ul class="list-unstyled ps-4">
                ...
                <li>
                    <a class="text-body-secondary sidebar-subitem side-link d-flex align-items-center px-3 rounded py-2 text-decoration-none" href="/admin/obat">
